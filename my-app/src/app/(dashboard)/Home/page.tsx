        ...
        <section className="mb-4 sm:mb-6 md:mb-8">
          <div className="relative max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg mx-auto">
            <input
              ...
              className="w-full p-2 sm:p-3 md:p-4 pr-8 sm:pr-10 md:pr-12 rounded-full border border-orange-300 focus:outline-none focus:ring-2 focus:ring-orange-500 text-sm sm:text-base md:text-lg"
